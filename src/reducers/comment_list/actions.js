...
export function postCommentAction(devotionalId, comment) {
  return function (dispatch) {
    ...
    function success() {
      ...
      ToastAndroid.show('Se agregó el comentario al devocional', ToastAndroid.SHORT);
    }
    ...
    function error(error) {
      ...
      ToastAndroid.show('Se produjo un error creando el comentario, inténtalo de nuevo más tarde', ToastAndroid.SHORT);
    }
  };
}
